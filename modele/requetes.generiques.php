 ...
 * @return array
 */
function recupereTous(PDO $bdd, string $table): array { // récupere tous les élémens d'une table
 ...
 * @return array
 */
function recherche(PDO $bdd, string $table, array $attributs): array { // recherche un élément dans une table contenant des attributs
 ...
 * @return boolean
 */
function insertion(PDO $bdd, array $values, string $table): bool { //insérer dans la BDD des nouvelles lignes
