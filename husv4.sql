...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 21 déc. 2017 à 15:34
...
(15, 25, 0, 'edzlncin', '2017-12-14 08:49:51'),
(16, 0, 0, 'root', '2017-12-14 08:51:46');
...
INSERT INTO `consommation` (`ID`, `Date_de_depart`, `Date_arret`, `Temps_de_fonctionnement`, `Puissance`, `ID_Equipement`) VALUES
(1, '2017-12-18 09:00:00', '2017-12-18 10:00:00', 12, 30, 1);
...
DROP TABLE IF EXISTS `lien_utilisateur_habitat`;
...
--
-- Déchargement des données de la table `lien_utilisateur_habitat`
--

INSERT INTO `lien_utilisateur_habitat` (`ID`, `ID_Habitat`, `ID_Utilisateur`, `ID_Type_Utilisateur`) VALUES
(8, NULL, 29, 3),
(9, 1, 25, 1),
(10, NULL, 26, 4),
(11, 2, 27, 1),
...
(25, 'BRY', 'Nathan', 'nathan.bry@isep.fr', 'nathan', 130457896, 1212121212, 1, '2017-12-12', NULL),
...
(28, 'CHUPIN', 'Quentin', 'quentin.chupin@isep.fr', 'quentin', 11111111, 111111111, 0, '2017-12-13', NULL),
